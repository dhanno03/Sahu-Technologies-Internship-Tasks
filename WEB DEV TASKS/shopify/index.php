...
<head>
  ...
  <title>Living Room Collection</title>
...
<body>
    ...
    <div class="banner_inner d-flex align-items-center">
      <div class="container">
        <div class="banner_content row">
          <div class="col-lg-12">
            <p class="sub text-uppercase">Taking your viewing experience to next level</p>
            <h3><span>Living</span> Room <br />Collection</h3>
            <a class="main_btn mt-40" href="#">Shop Now</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!--================ Exclusive Products Area =================-->
  <section class="feature_product_area section_gap_bottom_custom">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-12">
          <div class="main_title">
            <h2><span>Exclusive Products</span></h2>
          </div>
        </div>
      </div>
          ...
          <div class="single-product">
            ...
            <div class="product-btm">
              <a href="#" class="d-block">
                <h4>Leopard X-Stool</h4>
              </a>
              <div class="mt-3">
                <span class="mr-4">$45.00</span>
                <del>$66.25</del>
              </div>
            </div>
          </div>
      ...
      <div class="row justify-content-center">
        <div class="offset-lg-4 col-lg-6 text-center">
          <div class="offer_content">
            <h3 class="text-uppercase mb-40">New Collection</h3>
            <h2 class="text-uppercase">40% off</h2>
            <a href="#" class="main_btn mb-20 mt-5">Shop now</a>
      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="new_product">
            <h5 class="text-uppercase">New collection of 2021</h5>
            <h3 class="text-uppercase">Antique Resting Sofa</h3>
            <div class="product-img">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6">
              <div class="single-product">
                ...
                <div class="product-btm">
                  <a href="#" class="d-block">
                    <h4>Relaxing Desktop Chair</h4>
                  </a>
                  <div class="mt-3">
                    <span class="mr-4">$110.00</span>
                    <del>$140.00</del>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6 col-md-6">
              <div class="single-product">
                ...
                <div class="product-btm">
                  <a href="#" class="d-block">
                    <h4>Heavy Duty Office Chair</h4>
                  </a>
                  <div class="mt-3">
                    <span class="mr-4">$50.00</span>
                    <del>$70.00</del>
                  </div>
                </div>
              </div>
            ...
            <div class="col-lg-6 col-md-6">
              <div class="single-product">
                ...
                <div class="product-btm">
                  <a href="#" class="d-block">
                    <h4>Queen gold chair</h4>
                  </a>
                  <div class="mt-3">
                    <span class="mr-4">$160.00</span>
                    <del>$190.00</del>
                  </div>
                </div>
              </div>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6">
          <div class="single-product">
            ...
            <div class="product-btm">
              <a href="#" class="d-block">
                <h4>White Oak/Black Fabric Stools</h4>
              </a>
              <div class="mt-3">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="single-product">
            ...
            <div class="product-btm">
              <a href="#" class="d-block">
                <h4>Light Grey Fabric Bar Stool</h4>
              </a>
              <div class="mt-3">
        ...
        <div class="col-lg-3 col-md-6">
          <div class="single-product">
            ...
            <div class="product-btm">
              <a href="#" class="d-block">
                <h4>Matel Outdoor Bar Stool(2-Pack)</h4>
              </a>
              <div class="mt-3">
                <span class="mr-4">$45.00</span>
                <del>$65.00</del>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="single-product">
            ...
            <div class="product-btm">
              <a href="#" class="d-block">
                <h4>Adjustable dark coffee stool</h4>
              </a>
              <div class="mt-3">
                <span class="mr-4">$25.00</span>
                <del>$35.00</del>
        ...
        <div class="col-lg-3 col-md-6">
          <div class="single-product">
            ...
            <div class="product-btm">
              <a href="#" class="d-block">
                <h4>lattice black wood chair</h4>
              </a>
              <div class="mt-3">
                <span class="mr-4">$25.00</span>
                <del>$35.00</del>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 single-footer-widget">
          ...
          <ul>
            ...
            <li><a href="#"><i class="fa fa-facebook" style="font-size:30px"></i></a> &nbsp
              <a href="#"><i class="fa fa-twitter" style="font-size:30px"></i></a> &nbsp
              <a href="#"><i class="fa fa-dribbble" style="font-size:30px"></i></a> &nbsp
              <a href="#"><i class="fa fa-behance" style="font-size:30px"></i></a></li>
          </ul>
        </div>
        <div class="col-lg-3 col-md-6 single-footer-widget">
          <h4>Useful Links</h4>
        ...
        <div class="col-lg-3 col-md-6 single-footer-widget">
          ...
          <p>If you want to get an email from us everytime we have a new special offer, then sign up here!</p>
