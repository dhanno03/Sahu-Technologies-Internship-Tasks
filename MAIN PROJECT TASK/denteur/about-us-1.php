    ...
    <div class="sections">
        <div class="container">
            <div class="pages-title">
                <h1>Denteur <br> <span>About Us</span></h1>
    ...
    <section>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="about-info">
                  <h2>Caring For All Your Family’s Dental Needs</h2>
                  <p><strong>All practicing at Denteur have earned either three or more years of undergraduate .</strong></p>
        ...
        <div class="container">
            ...
            <div class="team-carousel slider hover-effects image-hover">
              ...
              <div class="slide">
                 <div class="team-portrait">
                    <figure class="tp-avatar"><img src="img/images/staff7.jpg" alt=""></figure>
                    <div class="tp-caption">
                      <h3>Jessica Lee</h3>
                      <h4>Orthodontist</h4>
                      <p>There are many variations of passages of Lorem Ipsum available but the majority.</p>
              ...
              <div class="slide">
                 <div class="team-portrait">
                    <figure class="tp-avatar"><img src="img/images/staff8.jpg" alt=""></figure>
                    <div class="tp-caption">
                      <h3>Ronald Cimino</h3>
                      <h4>Orthopedic</h4>
                      <p>There are many variations of passages of Lorem Ipsum available but the majority.</p>
