...
<body>
        ...
        <div class="top-header">
            <div class="container">
                <div class="header-left">
                    <p><i class="fa fa-phone"></i> &nbsp<strong>Phone :</strong> + 1 800 722 8987</p>
                </div>
                <div class="header-right">
                   <div class="ht-right-email">
                        <p><i class="fa fa-envelope"></i>&nbsp info@denteur.com</p>
                   </div>
                        ...
                        <ul class="nav-menu align-to-right">
                            ...
                            <li><a href="#">PAGES</a>
                                <ul class="nav-dropdown">
                                    <li><a href="about-us-1.php">About Us</a></li>
                            ...
                            <li><a href="#">DEPARTMENTS</a>
                                <ul class="nav-dropdown">
                                    <li><a href="department-endodontic.php">Endodontic</a></li>
                                    <li><a href="department-periodontics.php">Periodontics</a></li>
                                    <li><a href="department-prosthodontics.php">Prosthodontics</a></li>
                                    <li><a href="department-surgery.php">Surgery</a></li>
                                    <li><a href="department-orthodontic.php">Orthodontic</a></li>
                                    <li><a href="family-dentistry.php">Family Dentistry</a></li>
                                </ul>
                            </li> 
                            <li><a href="blog-1.php">BLOGS</a></li>
    ...
    <div class="home-slider">
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" role="listbox">
              ...
              <div class="carousel-item active" style="background-image: url('img/images/slider3.jpg')">
                <div class="container">
                    <div class="slider-caption">
                        <h2 class="display-4 animated fadeInRight">We Care For <br> <span>Your Smile</span></h2>
                        <p class="lead animated fadeInRight">Dentist is your primary care dental provider. This dentist diagnoses and treats.</p>
                        <div class="btn-more"><a class="btn btn-slider" href="#" role="button">Learn More</a></div>
                    </div>  
                </div>
              </div>
              <!-- Slide Two - Set the background image for this slide in the line below -->
              <div class="carousel-item" style="background-image: url('img/images/slider2.jpg')">
                <div class="container">
                    <div class="slider-caption">
                        <h2 class="display-4 animated fadeInRight">Creating <br> <span>Beautiful Smiles</span></h2>
                        <p class="lead animated fadeInRight">Dentist is your primary care dental provider. This dentist diagnoses and treats.</p>
                        <div class="btn-more"><a class="btn btn-slider" href="#" role="button">Learn More</a></div>
                    </div>  
                </div>
              ...
              <div class="carousel-item" style="background-image: url('img/images/img19.jpg')">
                <div class="container">
                    <div class="slider-caption">
                        <h2 class="display-4 animated fadeInRight">For a Good<br> <span>Oral Health </span></h2>
                        <p class="lead animated fadeInRight">Dentist is your primary care dental provider. This dentist diagnoses and treats.</p>
                        <div class="btn-more"><a class="btn btn-slider" href="#" role="button">Learn More</a></div>
                    </div>  
                </div>
            ...
            <div class="row">
                  <div class="col-lg-4 thumbnail-col">
                      <div class="info-layer">
                        <figure class="if-icon"><img src="img/master/phone-contact.svg" alt=""></figure>
                        <div class="if-caption">
                            <h4>Get In Touch <br><span>+ 1 800 722 8987</span></h4>
                        </div>
                      </div>
                  </div>
                  <div class="col-lg-4 layer-col">
                      <h3>Opening Hours</h3>
                      <div class="span-schedule">
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item"><a href="#">Mon to Fri</a>
                  ...
                  <div class="col-lg-4 layer-col form-col">
                      <h3>Book a Visit</h3>
                            ...
                            <div class="row" >
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input id="form_name" type="text" name="name" class="form-control layer-contact" placeholder="Name" required="required" data-error="Firstname is required.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input id="form_email" type="email" name="email" class="form-control layer-contact" placeholder="Email address" required="required" data-error="Valid email is required.">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <input id="form_phone" type="tel" name="phone" class="form-control layer-contact" placeholder="Phone number">
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
                                <div class="col-md-6 submit-btn">
                                    <p><input type="submit" class="btn btn-booking" value="Send Request"></p>
                                </div>
                            </div>
                        </div>
                    </form> 
    ...
    <section>
            ...
            <div class="row">
              <div class="col-lg-6">
                <div class="home-about">
                    <h5><i class="fa fa-th"></i>&nbsp ABOUT DENTEUR</h5>  
                    <h2>Welcome To Dental Care Denteur</h2>
                    ...
                    <div class="ha-bullets">
                        <div class="bullets-left">
                            <p><i class="fa fa-check"></i>&nbsp Anti-wrinkle treatment.</p>
                            <p><i class="fa fa-check"></i>&nbsp Varicose vein treatment.</p>
                            <p><i class="fa fa-check"></i>&nbsp Manual Handling Training.</p>
                        </div>
                    ...
                    <figure class="signature-alt"><img src="img/images/signature.png" alt=""></figure>
                </div>  
              </div>
              <div class="col-lg-6">
                <div class="organic-pulsing-video home-about-img">
                  <div class="youtube-popup" data-listnum="1" style="display: none">
                    <a href="3" class="popup-youtube">
                        <figure class="video-image"><img src="#" alt=""></figure>
                    </a>
        ...
        <div class="container-fluid">
            <div class="row">
              <div class="col-lg-5 parallax-side"></div>
              <div class="col-lg-7 content-side">
                <div class="inner-content">
                  ...
                  <p>Sharing your toothbrush is a great example of a bad habit that can negatively affect the health of your mouth, there are many habits that can have a positive impact, not only for your oral health. </p>
                  <hr class="divider">
                          ...
                          <div class="col-lg-6">
                            <div class="inner-service-box">
                                <div class="sp-icon-box">
                                    <figure class="sp-icon"><img src="img/master/dentist.svg" alt=""></figure>  
                                </div>
                                <div class="sp-caption">
                                    <h4>Excellence Defined</h4>
                                    <p>We are providing different services in this sector to wide.</p>
                                </div> 
                            </div>
                          </div>
                          <div class="col-lg-6 sp-space-break">
                            <div class="inner-service-box">
                                <div class="sp-icon-box">
                                    <figure class="sp-icon"><img src="img/master/tooth-saved.svg" alt=""></figure>  
                                </div>
                                <div class="sp-caption">
                                    <h4>Stunning smile</h4>
                                    <p>We are providing different services in this sector to wide.</p>
                                </div> 
                            </div>
                          </div>
        ...
        <div class="container">
            ...
            <div class="services-carousel slider hover-effects image-hover">
              <div class="slide">
                        ...
                        <div class="testimonials-box groucho">
                          <p>I just wanted to share a quick note and let you know that you guys do a really good job. I’m glad I decided to work with.</p>
                            <div class="tb-client-details">
                                <figure class="tb-client-avatar"><img src="#" alt=""></figure>
                                <div class="caption">
                                    <h4><strong>Sara Jones</strong> - Designer</h4>
                                    <div class="span-rating">
                                        <div class="inner-star"><i class="fa fa-star"></i></div>
                                        <div class="inner-star"><i class="fa fa-star"></i></div>
                                        <div class="inner-star"><i class="fa fa-star"></i></div>
                                        <div class="inner-star"><i class="fa fa-star"></i></div>
                                        <div class="inner-star"><i class="fa fa-star"></i></div>
        ...
        <div class="container-fluid parallax-section">
            <div class="container">
                <div class="parallax-label">
                    ...
                    <a class="btn btn-custom" href="#" role="button">Learn More</a>
                </div>
            </div>
        </div>
            ...
            <div class="news-carousel slider hover-effects image-hover">
              <div class="slide">
                <div class="thumbnail-box">
                    <figure class="tb-image"><img src="#" alt="Image"></figure>  
                    ...
                    <div class="tb-bottom">
                        <div class="tbb-inner">
                            <div class="user-box"><p><i class="fa fa-user"></i>&nbsp John Anderson</p></div>
                            <div class="comment-box-alt"><p><i class="fa fa-comments"></i>&nbsp 314</p></div>
                        </div>
                    </div>
                </div> 
              </div>
              <div class="slide">
                <div class="thumbnail-box">
                    ...
                    <div class="tb-bottom">
                        <div class="tbb-inner">
                            <div class="user-box"><p><i class="fa fa-user"></i>&nbsp Lisa Jones</p></div>
                            <div class="comment-box-alt"><p><i class="fa fa-comments"></i>&nbsp 245</p></div>
                        </div>
                    </div>
                </div> 
              </div>
              <div class="slide">
                <div class="thumbnail-box">
                    ...
                    <div class="tb-bottom">
                        <div class="tbb-inner">
                            <div class="user-box"><p><i class="fa fa-user"></i>&nbsp Sara Smith</p></div>
                            <div class="comment-box-alt"><p><i class="fa fa-comments"></i>&nbsp 433</p></div>
                        </div>
                    </div>
                </div> 
              </div>
              <div class="slide">
                <div class="thumbnail-box">
                    ...
                    <div class="tb-bottom">
                        <div class="tbb-inner">
                            <div class="user-box"><p><i class="fa fa-user"></i>&nbsp Tim Cook</p></div>
                            <div class="comment-box-alt"><p><i class="fa fa-comments"></i>&nbsp 189</p></div>
                        </div>
                    </div>
                </div> 
              </div>
        ...
        <div class="container">
            <div class="row">
              <div class="col-lg-3">
                <div class="footer-col">
                  <figure class="footer-logo"><img src="#" alt="LOGO"></figure>
                  <p>Denteur care about dental promote dental health through organized.</p>
                  <div class="footer-icon">
                    <div class="span-fi">
                        <div class="fi-caption">
                            <p><i class="fa fa-map-marker"></i>&nbsp PO BOX 33195 NW 56th ST Miami, Florida</p>  
                        </div>
                    </div> 
                    <div class="span-fi">
                        <div class="fi-caption">
                            <p><i class="fa fa-phone"></i>&nbsp Call US: + 1 800 722 8987</p>  
                        </div>
                    </div> 
                    <div class="span-fi">
                        <div class="fi-caption">
              ...
              <div class="col-lg-3">
                <div class="footer-col">
                  ...
                  <div class="media-post">
                      <figure class="media-thumb"><a href="#"><img src="#" alt="Image"></a></figure>
              ...
              <div class="col-lg-3">
                <div class="footer-col">
                  ...
                  <div class="popular-links">
                    <ul>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i>&nbsp About Us</a></li>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i>&nbsp Blogs & News</a></li>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i>&nbsp Contact US</a></li>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i>&nbsp Our Services</a></li>
                        <li><a href="#"><i class="fa fa-angle-double-right"></i>&nbsp Gallery</a></li>
                    </ul>  
                  </div>
                </div>
              </div>
            ...
            <div class="footer-bottom">
                <div class="fb-copyright">
                    <p>© 2019 Denteur - Responsive Dental & Medical HTML Template</p>
                </div>
                <div class="fb-social">
                    <div class="span-fb-social"><a href="#"><i class="fa fa-facebook-f"></i></a></div>
